"""v1.42 attention index kernel — v1.40 with dead code removed + tunable warps/stages.

Changes from v1.40:
  - Removed unused ``any_hq_lives_parent`` computation.
  - Exposes num_warps/num_stages as tunable parameters (caller picks).
"""
...
if HAS_TRITON:
    ...
    @triton.jit
    def _fused_attn_index_v1_42_kernel(
        Q_ptr,
        KeysBlocksT_ptr,
        ValuesBlocks_ptr,
        CentersAnchor_ptr,
...
def run_fused_attn_index_v1_42(
    q: torch.Tensor,
    ...
    _fused_attn_index_v1_42_kernel[grid](
        q,
        keys_blocks_t_f16,
        values_blocks_f16,
        centers_anchor,
