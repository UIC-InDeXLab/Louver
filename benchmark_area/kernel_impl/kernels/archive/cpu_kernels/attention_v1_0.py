"""attention_v1.0 — scalar reference, OpenMP over H_q only.

Two-pass softmax with full per-subspace bound checks. Treat this as the
correctness floor; v1.x sub-versions iterate on parallelism, vectorization,
and gating.
"""
