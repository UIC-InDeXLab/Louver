"""v1.34 anchor-only cluster-pass kernel with fp16 q/th/centers/radii/qnorms."""
...
if HAS_TRITON:
    ...
    @triton.jit
    def _anchor_cluster_pass_rawq_fp16_v1_34_kernel(
        Q_ptr,
        QNormAnchor_ptr,
        ThAnchor_ptr,
        CentersAnchor_ptr,
...
def triton_anchor_cluster_pass_rawq_fp16(
    q: torch.Tensor,
    ...
    _anchor_cluster_pass_rawq_fp16_v1_34_kernel[grid](
        q,
        q_norm_anchor,
        th_anchor,
        centers_anchor,
