"""search_v7.0 — Triton direct kernel tuned with larger BLOCK_N.

Same algorithm as v5.0 but with BLOCK_N=128 and num_warps=8 to improve
memory-bandwidth utilization on long N.
"""
...
def search(
    ...
    layout = get_layout_cache(
        ...
        cache_name="_search_v7_0_cache",
    )
    dots = triton_direct_search(q, th_per_subspace, layout, block_n=128, num_warps=8)
