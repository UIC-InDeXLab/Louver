"""v1.18.1 cluster-pass kernel with fp16 q/th/centers/radii/qnorms inputs."""
...
if HAS_TRITON:
    ...
    @triton.jit
    def _fused_cluster_pass_rawq_fp16_kernel(
        Q_ptr,
        QNorms_ptr,
        DimOffsets_ptr,
        DimWidths_ptr,
...
def triton_fused_cluster_pass_rawq_g4_fp16(
    q: torch.Tensor,
    ...
    _fused_cluster_pass_rawq_fp16_kernel[grid](
