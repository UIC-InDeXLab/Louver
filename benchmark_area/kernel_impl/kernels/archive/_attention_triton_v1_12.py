"""v1.12 — v1.10 parent-list kernel with num_stages=2 (async pipelining)."""
...
if HAS_TRITON:
    ...
    @triton.jit
    def _fused_attn_index_parentlist_ns_kernel(
        Q_ptr,
        KeysBlocksT_ptr,
        ValuesBlocks_ptr,
        ParentIds_ptr,
...
def run_fused_attn_index_parentlist_pipelined(
    q: torch.Tensor,
    ...
    _fused_attn_index_parentlist_ns_kernel[grid](
        q,
        keys_blocks_t_f16,
        values_blocks_f16,
        parent_ids,
