"""v1.30 buffered finalization kernel — reduce sparse partials and scan buffer."""
...
if HAS_TRITON:
    ...
    @triton.jit
    def _attn_reduce_buffer_kernel(
        Q_ptr,
        M_idx_ptr,
        L_idx_ptr,
        O_idx_ptr,
...
def run_attn_reduce_buffer(
    ...
    _attn_reduce_buffer_kernel[grid](
        q,
        m_idx,
        l_idx,
        o_idx,
