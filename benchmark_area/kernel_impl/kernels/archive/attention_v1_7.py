"""attention_v1.7 — fixed BF=4/S=8 tuned variant of v1.5.

Changes vs v1.5:
  - Requires bf=4 and S=8.
  - Uses a tighter GROUPS_POW floor of 4 instead of 8.
  - Defaults to NUM_SPLITS=32 for the bf=4 regime.
  - Reuses the empty-buffer partial workspace.
"""
...
def attend(
    ...
    ws = state.setdefault("_attn_v1_7_ws", {})
